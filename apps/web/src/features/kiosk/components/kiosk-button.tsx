...
type KioskVariant = 'primary' | 'soft' | 'ghost';

const VARIANTS: Record<KioskVariant, string> = {
  primary:
...
/** Premium kiosk button — navy primary / soft card / ghost, with a subtle press. */
export function KioskButton({
  kioskVariant = 'primary',
  className,
  ...props
}: ButtonProps & { kioskVariant?: KioskVariant }) {
  return (
    <Button
      variant="ghost"
      {...props}
