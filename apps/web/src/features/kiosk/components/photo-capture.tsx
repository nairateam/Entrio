...
/**
 * Live headshot capture (PRD v2 §3 Steps 5–6) — a kiosk-grade viewfinder with
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center gap-3">
        {value ? (
          <KioskButton kioskVariant="soft" size="lg" onClick={() => onChange(null)} className="px-8">
            <RotateCcw className="h-5 w-5" /> Retake picture
          </KioskButton>
        ) : (
          <KioskButton size="lg" onClick={capture} disabled={Boolean(error)} className="px-10">
